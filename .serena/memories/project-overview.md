...
## 目的
mkiln is a thin Go CLI around Pandoc. Its primary path converts Markdown with LaTeX math to standalone HTML using Pandoc defaults, CSS, and KaTeX; its secondary path emits plain Typst source only.
