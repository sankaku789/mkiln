...
- Thin Go CLI around Pandoc: Markdown to standalone HTML is primary; plain Typst source is secondary.
- Keep HTML and Typst flows explicit. `-t`/`--typst` is a bool, never a generic target option.
